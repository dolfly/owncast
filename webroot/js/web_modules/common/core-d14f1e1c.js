...
var window$1 = _interopDefault(window_1$1);
var document$1 = _interopDefault(document_1$1);
var _extends = _interopDefault(_extends_1);
var _assertThisInitialized$1 = _interopDefault(assertThisInitialized);


var _inheritsLoose$1 = _interopDefault(inheritsLoose);
var safeParseTuple = _interopDefault(tuple);
var keycode$1 = _interopDefault(keycode);
var XHR = _interopDefault(xhr);
var vtt$1 = _interopDefault(browserIndex);
...
var ModalDialog = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(ModalDialog, _Component);
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    if (keycode$1.isEventKey(event, 'Escape') && this.closeable()) {
      event.preventDefault();
      this.close();
      return;
    ...
    if (!keycode$1.isEventKey(event, 'Tab')) {
      return;
    }
...
var TrackList = /*#__PURE__*/function (_EventTarget) {
  _inheritsLoose$1(TrackList, _EventTarget);
  ...
  function TrackList(tracks) {
    ...
    Object.defineProperty(_assertThisInitialized$1(_this), 'length', {
      get: function get() {
...
var AudioTrackList = /*#__PURE__*/function (_TrackList) {
  _inheritsLoose$1(AudioTrackList, _TrackList);
...
var VideoTrackList = /*#__PURE__*/function (_TrackList) {
  _inheritsLoose$1(VideoTrackList, _TrackList);
  ...
  function VideoTrackList(tracks) {
    ...
    Object.defineProperty(_assertThisInitialized$1(_this), 'selectedIndex', {
      get: function get() {
...
var TextTrackList = /*#__PURE__*/function (_TrackList) {
  _inheritsLoose$1(TextTrackList, _TrackList);
...
var Track = /*#__PURE__*/function (_EventTarget) {
  _inheritsLoose$1(Track, _EventTarget);
  ...
  function Track(options) {
    ...
    var _loop = function _loop(key) {
      Object.defineProperty(_assertThisInitialized$1(_this), key, {
        get: function get() {
...
var TextTrack = /*#__PURE__*/function (_Track) {
  _inheritsLoose$1(TextTrack, _Track);
  ...
  function TextTrack(options) {
    ...
    var changed = false;
    var timeupdateHandler = bind(_assertThisInitialized$1(_this), function () {
    ...
    if (settings.src) {
      ...
      if (_this.preload_ || default_ || settings.kind !== 'subtitles' && settings.kind !== 'captions') {
        loadTrack(_this.src, _assertThisInitialized$1(_this));
      }
    } else {
      _this.loaded_ = true;
    }
...
var AudioTrack = /*#__PURE__*/function (_Track) {
  _inheritsLoose$1(AudioTrack, _Track);
  ...
  function AudioTrack(options) {
    ...
    Object.defineProperty(_assertThisInitialized$1(_this), 'enabled', {
      get: function get() {
        return enabled;
      },
...
var VideoTrack = /*#__PURE__*/function (_Track) {
  _inheritsLoose$1(VideoTrack, _Track);
  ...
  function VideoTrack(options) {
    ...
    Object.defineProperty(_assertThisInitialized$1(_this), 'selected', {
      get: function get() {
        return selected;
      },
...
var HTMLTrackElement = /*#__PURE__*/function (_EventTarget) {
  _inheritsLoose$1(HTMLTrackElement, _EventTarget);
...
var Tech = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(Tech, _Component);
  ...
  */
  ...
  _proto.addWebVttScript_ = function addWebVttScript_() {
    ...
    if (document$1.body.contains(this.el())) {
      ...
      if (!this.options_['vtt.js'] && isPlain(vtt$1) && Object.keys(vtt$1).length > 0) {
...
var MediaLoader = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(MediaLoader, _Component);
...
var ClickableComponent = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(ClickableComponent, _Component);
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    // Player hotkeys.
    if (keycode$1.isEventKey(event, 'Space') || keycode$1.isEventKey(event, 'Enter')) {
      event.preventDefault();
      event.stopPropagation();
      this.trigger('click');
    } else {
...
var PosterImage = /*#__PURE__*/function (_ClickableComponent) {
  _inheritsLoose$1(PosterImage, _ClickableComponent);
  ...
  function PosterImage(player, options) {
    ...
    player.on('posterchange', bind(_assertThisInitialized$1(_this), _this.update));
    return _this;
  }
  /**
...
var TextTrackDisplay = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(TextTrackDisplay, _Component);
  ...
  function TextTrackDisplay(player, options, ready) {
    ...
    var updateDisplayHandler = bind(_assertThisInitialized$1(_this), _this.updateDisplay);
    player.on('loadstart', bind(_assertThisInitialized$1(_this), _this.toggleDisplay));
    player.on('texttrackchange', updateDisplayHandler);
    player.on('loadedmetadata', bind(_assertThisInitialized$1(_this), _this.preselectTrack)); // This used to be called during player init, but was causing an error
    // if a track should show by default and the display hadn't loaded yet.
    // Should probably be moved to an external track loader when we support
    // tracks that don't need a display.

    player.ready(bind(_assertThisInitialized$1(_this), function () {
...
var LoadingSpinner = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(LoadingSpinner, _Component);
...
var Button = /*#__PURE__*/function (_ClickableComponent) {
  _inheritsLoose$1(Button, _ClickableComponent);
...
var BigPlayButton = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(BigPlayButton, _Button);
...
var CloseButton = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(CloseButton, _Button);
  ...
  */
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    if (keycode$1.isEventKey(event, 'Esc')) {
      event.preventDefault();
      event.stopPropagation();
      this.trigger('click');
    } else {
...
var PlayToggle = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(PlayToggle, _Button);
...
var TimeDisplay = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(TimeDisplay, _Component);
...
var CurrentTimeDisplay = /*#__PURE__*/function (_TimeDisplay) {
  _inheritsLoose$1(CurrentTimeDisplay, _TimeDisplay);
...
var DurationDisplay = /*#__PURE__*/function (_TimeDisplay) {
  _inheritsLoose$1(DurationDisplay, _TimeDisplay);
...
var TimeDivider = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(TimeDivider, _Component);
...
var RemainingTimeDisplay = /*#__PURE__*/function (_TimeDisplay) {
  _inheritsLoose$1(RemainingTimeDisplay, _TimeDisplay);
...
var LiveDisplay = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(LiveDisplay, _Component);
...
var SeekToLive = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(SeekToLive, _Button);
...
var Slider = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(Slider, _Component);
  ...
  */
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    if (keycode$1.isEventKey(event, 'Left') || keycode$1.isEventKey(event, 'Down')) {
      event.preventDefault();
      event.stopPropagation();
      this.stepBack(); // Up and Right Arrows
    } else if (keycode$1.isEventKey(event, 'Right') || keycode$1.isEventKey(event, 'Up')) {
      event.preventDefault();
      event.stopPropagation();
      this.stepForward();
    } else {
...
var LoadProgressBar = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(LoadProgressBar, _Component);
...
var TimeTooltip = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(TimeTooltip, _Component);
  ...
  function TimeTooltip(player, options) {
    ...
    _this = _Component.call(this, player, options) || this;
    _this.update = throttle(bind(_assertThisInitialized$1(_this), _this.update), UPDATE_REFRESH_INTERVAL);
    return _this;
  }
  /**
...
var PlayProgressBar = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(PlayProgressBar, _Component);
...
var MouseTimeDisplay = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(MouseTimeDisplay, _Component);
...
var SeekBar = /*#__PURE__*/function (_Slider) {
  _inheritsLoose$1(SeekBar, _Slider);
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    } else if (keycode$1.isEventKey(event, 'Home')) {
      event.preventDefault();
      event.stopPropagation();
      this.player_.currentTime(0);
    } else if (keycode$1.isEventKey(event, 'End')) {
      event.preventDefault();
      event.stopPropagation();
      this.player_.currentTime(this.player_.duration());
    } else if (/^[0-9]$/.test(keycode$1(event))) {
      event.preventDefault();
      event.stopPropagation();
      var gotoFraction = (keycode$1.codes[keycode$1(event)] - keycode$1.codes['0']) * 10.0 / 100.0;
      this.player_.currentTime(this.player_.duration() * gotoFraction);
    } else if (keycode$1.isEventKey(event, 'PgDn')) {
      event.preventDefault();
      event.stopPropagation();
      this.player_.currentTime(this.player_.currentTime() - STEP_SECONDS * PAGE_KEY_MULTIPLIER);
    } else if (keycode$1.isEventKey(event, 'PgUp')) {
      event.preventDefault();
      event.stopPropagation();
      this.player_.currentTime(this.player_.currentTime() + STEP_SECONDS * PAGE_KEY_MULTIPLIER);
    } else {
...
var ProgressControl = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(ProgressControl, _Component);
  ...
  function ProgressControl(player, options) {
    ...
    _this = _Component.call(this, player, options) || this;
    _this.handleMouseMove = throttle(bind(_assertThisInitialized$1(_this), _this.handleMouseMove), UPDATE_REFRESH_INTERVAL);
    _this.throttledHandleMouseSeek = throttle(bind(_assertThisInitialized$1(_this), _this.handleMouseSeek), UPDATE_REFRESH_INTERVAL);
...
var PictureInPictureToggle = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(PictureInPictureToggle, _Button);
...
var FullscreenToggle = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(FullscreenToggle, _Button);
...
var VolumeLevel = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(VolumeLevel, _Component);
...
var VolumeBar = /*#__PURE__*/function (_Slider) {
  _inheritsLoose$1(VolumeBar, _Slider);
...
var VolumeControl = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(VolumeControl, _Component);
  ...
  function VolumeControl(player, options) {
    ...
    _this.throttledHandleMouseMove = throttle(bind(_assertThisInitialized$1(_this), _this.handleMouseMove), UPDATE_REFRESH_INTERVAL);
...
var MuteToggle = /*#__PURE__*/function (_Button) {
  _inheritsLoose$1(MuteToggle, _Button);
  ...
  function MuteToggle(player, options) {
    ...
    checkMuteSupport(_assertThisInitialized$1(_this), player);
...
var VolumePanel = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(VolumePanel, _Component);
...
var Menu = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(Menu, _Component);
  ...
  function Menu(player, options) {
    ...
    _this.boundHandleBlur_ = bind(_assertThisInitialized$1(_this), _this.handleBlur);
    _this.boundHandleTapClick_ = bind(_assertThisInitialized$1(_this), _this.handleTapClick);
    return _this;
  }
  /**
...
var MenuButton = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(MenuButton, _Component);
  ...
  function MenuButton(player, options) {
    ...
    _this.on(_this.menuButton_, 'mouseenter', function () {
      ...
      on(document$1, 'keyup', bind(_assertThisInitialized$1(_this), _this.handleMenuKeyUp));
    });
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    ...
    if (keycode$1.isEventKey(event, 'Esc') || keycode$1.isEventKey(event, 'Tab')) {
      if (this.buttonPressed_) {
        this.unpressButton();
    ...
    } else if (keycode$1.isEventKey(event, 'Up') || keycode$1.isEventKey(event, 'Down')) {
      if (!this.buttonPressed_) {
        event.preventDefault();
        this.pressButton();
      }
...
var TrackButton = /*#__PURE__*/function (_MenuButton) {
  _inheritsLoose$1(TrackButton, _MenuButton);
  ...
  function TrackButton(player, options) {
    ...
    var updateHandler = bind(_assertThisInitialized$1(_this), _this.update);
...
var MenuItem = /*#__PURE__*/function (_ClickableComponent) {
  _inheritsLoose$1(MenuItem, _ClickableComponent);
  ...
  _proto.handleKeyDown = function handleKeyDown(event) {
    if (!MenuKeys.some(function (key) {
      return keycode$1.isEventKey(event, key);
    })) {
...
var TextTrackMenuItem = /*#__PURE__*/function (_MenuItem) {
  _inheritsLoose$1(TextTrackMenuItem, _MenuItem);
  ...
  function TextTrackMenuItem(player, options) {
    ...
    var changeHandler = function changeHandler() {
      ...
      _this.handleTracksChange.apply(_assertThisInitialized$1(_this), args);
    };
    ...
    var selectedLanguageChangeHandler = function selectedLanguageChangeHandler() {
      ...
      _this.handleSelectedLanguageChange.apply(_assertThisInitialized$1(_this), args);
    };
...
var TextTrackButton = /*#__PURE__*/function (_TrackButton) {
  _inheritsLoose$1(TextTrackButton, _TrackButton);
...
var ChaptersTrackMenuItem = /*#__PURE__*/function (_MenuItem) {
  _inheritsLoose$1(ChaptersTrackMenuItem, _MenuItem);
  ...
  function ChaptersTrackMenuItem(player, options) {
    ...
    _this.track = track;
    _this.cue = cue;
    track.addEventListener('cuechange', bind(_assertThisInitialized$1(_this), _this.update));
    return _this;
  }
  /**
...
var ChaptersButton = /*#__PURE__*/function (_TextTrackButton) {
  _inheritsLoose$1(ChaptersButton, _TextTrackButton);
...
var DescriptionsButton = /*#__PURE__*/function (_TextTrackButton) {
  _inheritsLoose$1(DescriptionsButton, _TextTrackButton);
  ...
  function DescriptionsButton(player, options, ready) {
    ...
    var changeHandler = bind(_assertThisInitialized$1(_this), _this.handleTracksChange);
    tracks.addEventListener('change', changeHandler);
...
var SubtitlesButton = /*#__PURE__*/function (_TextTrackButton) {
  _inheritsLoose$1(SubtitlesButton, _TextTrackButton);
...
var CaptionSettingsMenuItem = /*#__PURE__*/function (_TextTrackMenuItem) {
  _inheritsLoose$1(CaptionSettingsMenuItem, _TextTrackMenuItem);
...
var CaptionsButton = /*#__PURE__*/function (_TextTrackButton) {
  _inheritsLoose$1(CaptionsButton, _TextTrackButton);
...
var SubsCapsMenuItem = /*#__PURE__*/function (_TextTrackMenuItem) {
  _inheritsLoose$1(SubsCapsMenuItem, _TextTrackMenuItem);
...
var SubsCapsButton = /*#__PURE__*/function (_TextTrackButton) {
  _inheritsLoose$1(SubsCapsButton, _TextTrackButton);
...
var AudioTrackMenuItem = /*#__PURE__*/function (_MenuItem) {
  _inheritsLoose$1(AudioTrackMenuItem, _MenuItem);
...
var AudioTrackButton = /*#__PURE__*/function (_TrackButton) {
  _inheritsLoose$1(AudioTrackButton, _TrackButton);
...
var PlaybackRateMenuItem = /*#__PURE__*/function (_MenuItem) {
  _inheritsLoose$1(PlaybackRateMenuItem, _MenuItem);
...
var PlaybackRateMenuButton = /*#__PURE__*/function (_MenuButton) {
  _inheritsLoose$1(PlaybackRateMenuButton, _MenuButton);
...
var Spacer = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(Spacer, _Component);
...
var CustomControlSpacer = /*#__PURE__*/function (_Spacer) {
  _inheritsLoose$1(CustomControlSpacer, _Spacer);
...
var ControlBar = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(ControlBar, _Component);
...
var ErrorDisplay = /*#__PURE__*/function (_ModalDialog) {
  _inheritsLoose$1(ErrorDisplay, _ModalDialog);
...
var TextTrackSettings = /*#__PURE__*/function (_ModalDialog) {
  _inheritsLoose$1(TextTrackSettings, _ModalDialog);
  ...
  function TextTrackSettings(player, options) {
    ...
    _this = _ModalDialog.call(this, player, options) || this;
    _this.updateDisplay = bind(_assertThisInitialized$1(_this), _this.updateDisplay); // fill the modal and pretend we have opened it
...
var ResizeManager = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(ResizeManager, _Component);
...
var LiveTracker = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(LiveTracker, _Component);
...
var Player = /*#__PURE__*/function (_Component) {
  _inheritsLoose$1(Player, _Component);
  ...
  function Player(tag, options, ready) {
    ...
    _this.boundDocumentFullscreenChange_ = bind(_assertThisInitialized$1(_this), _this.documentFullscreenChange_);
    _this.boundFullWindowOnEscKey_ = bind(_assertThisInitialized$1(_this), _this.fullWindowOnEscKey); // default isFullscreen_ to false
    ...
    evented(_assertThisInitialized$1(_this), {
      eventBusKey: 'el_'
    ...
    Player.players[_this.id_] = _assertThisInitialized$1(_this); // Add a major version class to aid css in plugins
  ...
  _proto.handleHotkeys = function handleHotkeys(event) {
    ...
    var _hotkeys$fullscreenKe = hotkeys.fullscreenKey,
      ...
      return keycode$1.isEventKey(keydownEvent, 'f');
    } : _hotkeys$fullscreenKe,
        _hotkeys$muteKey = hotkeys.muteKey,
        muteKey = _hotkeys$muteKey === void 0 ? function (keydownEvent) {
      return keycode$1.isEventKey(keydownEvent, 'm');
    } : _hotkeys$muteKey,
        _hotkeys$playPauseKey = hotkeys.playPauseKey,
        playPauseKey = _hotkeys$playPauseKey === void 0 ? function (keydownEvent) {
      return keycode$1.isEventKey(keydownEvent, 'k') || keycode$1.isEventKey(keydownEvent, 'Space');
...
var extend = function extend(superClass, subClassMethods) {
  ...
  _inherits$1(subClass, superClass); // this is needed for backward-compatibility and node compatibility.
